...
We also recommend not starting a new line in the middle of something that's between square brackets (in particular references and in-line footnote) as it would break the way babeldown tries to protect those.
